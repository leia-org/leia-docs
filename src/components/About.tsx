...
const About: React.FC = () => {
  ...
  return (
    <section id="acerca" className="py-24 bg-gray-50">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-500">Easy to use for anyone</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-gray-600" size={20} />
                <span className="text-gray-500">Complete customization</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-gray-600" size={20} />
                <span className="text-gray-500">Always available 24/7</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-gray-600" size={20} />
                <span className="text-gray-500">Completely secure data</span>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200">
            ...
            <div className="border-t border-gray-200 pt-6">
              <h4 className="font-semibold text-black mb-3">Our Vision</h4>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="text-3xl md:text-4xl font-semibold text-black mb-2">
                {stat.number}
              </div>
